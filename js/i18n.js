...
const translations = {
  de: {
    ...
    "services.title": "Technische Lösungen aus einer Hand",
    "services.item1.title": "CAD-Konstruktion",
    "services.item1.desc": "Individuelle Bauteile und technische Lösungen — neu entwickelt oder nach deinen Anforderungen konstruiert.",
    "services.item2.title": "Reverse Engineering",
    "services.item2.desc": "Vorhandene, beschädigte oder nicht mehr erhältliche Bauteile werden erfasst und digital nachkonstruiert.",
    "services.item3.title": "3D-Druck & Fertigung",
    "services.item3.desc": "Funktionale Bauteile aus geeigneten technischen Kunststoffen — abgestimmt auf Geometrie und Anwendung.",
  ...
  en: {
    ...
    "services.title": "Technical solutions from a single source",
    "services.item1.title": "CAD design",
    "services.item1.desc": "Custom parts and technical solutions — newly developed or engineered to your requirements.",
    "services.item2.title": "Reverse engineering",
    "services.item2.desc": "Existing, damaged, or discontinued parts are captured and digitally redesigned.",
